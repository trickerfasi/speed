#!/usr/bin/python2
#coding=utf-8
#Codded By Fasi Tricker
#Facebook : Fasi Tricker
#Whatsapp : +923030299818
...
\x1b[1;97m╚═╝░░░░░╚═╝░░╚═╝╚═════╝░╚═╝
\x1b[1;97m--------------------------------------------------------------
\x1b[1;94m➣  YouTube  : Fasi Tricker
\x1b[1;94m➣  Facebook : fas1tricker
\x1b[1;94m➣  Github   : https://github.com/fasitricker
\x1b[1;94m➣  Whatsapp : +923030299818
\x1b[1;94m➣  Note     : Contact Me On Whatsapp.
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "\033[1;97mAccess Granted "#Dev:Fasi_Tricker
	    time.sleep(1)
            loop = 'false'
        else:
